# Frontend Architecture Decision: TanStack + Vite + React

While the default stack for full-stack web applications is TanStack, it's crucial to understand its trade-offs compared to a more focused client-side setup like Vite + React. This guide clarifies when to use each approach.
...
### 2. TanStack: The Full-Stack React Framework

TanStack is an opinionated, all-in-one framework that extends React to handle both frontend and backend concerns.
...
*   **Learn TanStack **[./tanstack.md]**

### Decision Rubric

| Consideration           | Choose Vite + React                               | Choose TanStack (Default)                          |
|-------------------------|---------------------------------------------------|---------------------------------------------------|
